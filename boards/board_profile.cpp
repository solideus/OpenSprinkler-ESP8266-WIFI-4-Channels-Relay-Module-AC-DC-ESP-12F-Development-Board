...
const BoardProfile RELAY4_PROFILE OSBOARD_PROGMEM = {
	{{RELAY4_BUTTON_PINS[0], RELAY4_BUTTON_PINS[1], RELAY4_BUTTON_PINS[2]},
	 {1, 3, UNUSED_PIN, UNUSED_PIN},
	 {UNUSED_PIN, UNUSED_PIN, UNUSED_PIN, UNUSED_PIN},
	 UNUSED_PIN, UNUSED_PIN, UNUSED_PIN, UNUSED_PIN,
	 UNUSED_PIN, UNUSED_PIN, UNUSED_PIN, UNUSED_PIN},
	2,
...
void select(ProfileId id) {
	...
	switch (id) {
	case PROFILE_ESP8266_4CH_RELAY:
		profile = &RELAY4_PROFILE;
		break;
	case PROFILE_OS_30:
