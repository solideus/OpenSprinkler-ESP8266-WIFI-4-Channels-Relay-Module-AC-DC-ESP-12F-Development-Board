...
/** Hardware defines */
	...
	#define ETHER_BUFFER_ALLOC_SIZE   ETHER_BUFFER_SIZE
		...
		// ESP8266-WIFI-4-Channels-Relay-Module (ESP-12F)
		#define RELAY4_PIN_STATION_1  16
		#define RELAY4_PIN_STATION_2  14
		#define RELAY4_PIN_STATION_3  12
		#define RELAY4_PIN_STATION_4  13
		#define RELAY4_PIN_BUTTON_1    2
		#define RELAY4_PIN_BUTTON_2   15
		#define RELAY4_PIN_BUTTON_3    0
		#define RELAY4_PIN_SENSOR_1    1
		#define RELAY4_PIN_SENSOR_2    3
	#endif
