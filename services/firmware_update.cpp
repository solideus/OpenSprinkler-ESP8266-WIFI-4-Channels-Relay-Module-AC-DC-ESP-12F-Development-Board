...
bool FirmwareUpdateService::configured() const {
	...
	// Official signed images do not contain this board's relay/pin adaptation.
	// Keep authenticated manual .bin uploads available for custom releases.
	return false;
#else
